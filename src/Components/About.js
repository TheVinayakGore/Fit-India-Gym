...
const About = ({ darkMode }) => {
    return (
        <div className={`about flex items-start justify-between m-auto space-x-20 px-16 py-32 ${darkMode ? "bg-gradient-to-t from-transparent to-black" : "bg-gradient-to-t from-white to-cyan-300"} h-full`}>
            <div>
            ...
            <div className="flex flex-col items-start justify-between space-y-5 h-full">
                ...
                <a href="/"><button className='text-md text-white p-2 bg-gradient-to-r from-red-800 to-blue-800 hover:from-yellow-600 hover:to-pink-500 rounded-md font-semibold w-52'>Read More</button></a>
            </div>
        </div>
    )
}
